...
class SingularVD(Transformer):
    ...
    def __standard_features(self, df, with_mean=True, with_std=True,
        ...
        try:
            ...
            raise OphileaMLException(f"An error occurred while calling __standard_features() method: {te}")
    ...
    def __index_row_matrix_rdd(self, scale_df):
        ...
        try:
            ...
            raise OphileaMLException(f"An error occurred while calling __index_row_matrix_rdd() method: {te}")
    ...
    def find_k(var_array, offset=95):
        ...
        try:
            ...
            raise OphileaMLException(f"An error occurred while calling find_k() method: {te}")
    ...
    def svd_set_dict(self, df, d, tot_row, k, compute_u=True):
        ...
        try:
            ...
            raise OphileaMLException(f"An error occurred while calling svd_set_dict() method: {te}")
    ...
    def __foreach_pc_var_print(self, search_func, tot_var, var_list=(75, 85, 95)):
        ...
        try:
            ...
            raise OphileaMLException(f"An error occurred while calling __foreach_pc_var_print() method: {te}")
    ...
    def optimal_pc(self, svd_set_dict, offset):
        ...
        try:
            ...
            raise OphileaMLException(f"An error occurred while calling optimal_pc() method: {te}")
