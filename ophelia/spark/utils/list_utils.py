...
from ophelia.spark import OpheliaListUtilsException
...
class ListUtils:
    ...
    def year_array(self, from_year: Any, to_year: Any) -> List:
        """
        ...
        """
        try:
            self.__logger.info(f"Window Data From Year {from_year} To {to_year}")
    ...
    def dates_index(self, dates_list: List) -> Callable:
        ...
        try:
            ...
            self.__logger.info("Set Date Index")
    ...
    def sorted_date_list(self, df: DataFrame, col_collect: AnyStr) -> List:
        """
    ...
    @staticmethod
    def feature_pick(df: DataFrame) -> Dict[AnyStr, List]:
        """
    ...
    def simple_average(self, series: List):
        """
        ...
        """
        try:
            self.__logger.info("Compute Simple Average")
