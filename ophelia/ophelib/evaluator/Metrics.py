...
class OpheliaMetrics:
    ...
    def gini_score(node):
        ...
        OpheliaMetrics.__logger.info(f'Gini Score for node {node} : {score}')
        return score
    ...
    def entropy_score(node):
        ...
        OpheliaMetrics.__logger.info(f'Entropy Score for node {node} : {score}')
        return score
    ...
    def information_gain(parent, children, criterion):
        ...
        OpheliaMetrics.__logger.info(f'Information gain: {gain}')
        return gain
